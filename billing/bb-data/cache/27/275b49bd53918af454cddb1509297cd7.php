...
class __TwigTemplate_a51875a639019f57b513cabb08313fac extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% endautoescape %}
{% endblock %}", "mod_email_index.phtml", "/var/www/vhosts/eniruvana.com/httpdocs/billing/bb-modules/Email/html_client/mod_email_index.phtml");
    }
}
