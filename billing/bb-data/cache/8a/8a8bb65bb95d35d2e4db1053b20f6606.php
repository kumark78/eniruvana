...
class __TwigTemplate_c2feff88ab3659730116a56ec3382b26 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% set bind_selector = request.bind_selector | default('.order-button') %}
    ...
    });", "mod_orderbutton_js.phtml", "/var/www/vhosts/eniruvana.com/httpdocs/billing/bb-modules/Orderbutton/html_client/mod_orderbutton_js.phtml");
    }
}
