...
class __TwigTemplate_2039e6da9a1d79404ab874c44ca3e2cf extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["unpaid_invoices"] ?? null), "total", [], "any", false, false, false, 40) > 0)) {
            ...
            foreach ($context['_seq'] as $context["i"] => $context["invoice"]) {
                ...
                echo "\">
                                <td>";
                // line 43
                echo twig_escape_filter($this->env, twig_sprintf("Proforma invoice #%05s", twig_get_attribute($this->env, $this->source, $context["invoice"], "id", [], "any", false, false, false, 43)), "html", null, true);
                echo "</td>
                                <td>";
                // line 44
        ...
        if ((twig_get_attribute($this->env, $this->source, ($context["paid_invoices"] ?? null), "total", [], "any", false, false, false, 76) > 0)) {
            ...
            foreach ($context['_seq'] as $context["i"] => $context["invoice"]) {
                ...
                echo "\">
                                <td>";
                // line 80
                echo twig_escape_filter($this->env, twig_sprintf("Proforma invoice #%05s", twig_get_attribute($this->env, $this->source, $context["invoice"], "id", [], "any", false, false, false, 80)), "html", null, true);
                echo "</td>
                                <td>";
                // line 81
...
", "mod_invoice_index.phtml", "/var/www/vhosts/eniruvana.com/httpdocs/billing/bb-modules/Invoice/html_client/mod_invoice_index.phtml");
    }
}
