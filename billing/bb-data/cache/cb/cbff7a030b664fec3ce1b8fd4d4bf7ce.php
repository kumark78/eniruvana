...
/* partial_menu.phtml */
class __TwigTemplate_877803bc61a6887c90a84eecdbd84711 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "/var/www/vhosts/eniruvana.com/httpdocs/billing/bb-themes/admin_default/html/partial_menu.phtml");
    }
}
