...
class __TwigTemplate_97191a378c2e386ca3d1918a80ed236f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_meta_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, twig_sprintf("%05s", twig_get_attribute($this->env, $this->source, ($context["invoice"] ?? null), "nr", [], "any", false, false, false, 3)), "html", null, true);
    }
    ...
    <li class=\"lastB\">";
        ...
        echo twig_escape_filter($this->env, twig_sprintf("%05s", twig_get_attribute($this->env, $this->source, ($context["invoice"] ?? null), "nr", [], "any", false, false, false, 11)), "html", null, true);
        echo "</li>
</ul>
";
    }
...
<div class=\"widget simpleTabs tabsRight\">
    ...
    <div class=\"tabs_container\">
        ...
        echo twig_escape_filter($this->env, twig_sprintf("%05s", twig_get_attribute($this->env, $this->source, ($context["invoice"] ?? null), "nr", [], "any", false, false, false, 43)), "html", null, true);
        echo "</td>
                    </tr>
                    <tr>
                        <td><label>";
...
{% endautoescape %}
{% endblock %}", "mod_invoice_invoice.phtml", "/var/www/vhosts/eniruvana.com/httpdocs/billing/bb-themes/admin_default/html/mod_invoice_invoice.phtml");
    }
}
